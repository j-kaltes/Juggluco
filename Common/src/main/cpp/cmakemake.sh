...
if test $btype = "Debug"
then
export  CXXFLAGS="$CXXFLAGS  -DRELEASEID=1 -DRELEASE=1 -DNORAWSTREAM=1   -DRELEASEDIR=1  -DSCANLOG=1 "
 export CFLAGS="$CFLAGS -DRELEASEID=1 -DRELEASE=1 -DNORAWSTREAM=1   -DRELEASEDIR=1  -DSCANLOG=1 "
 export DEBUGOPT="-DDEBUG=ON"
else
 export CXXFLAGS="$CXXFLAGS -DRELEASEID=1 -DRELEASE=1 -DNORAWSTREAM=1   -DRELEASEDIR=1  -DNOLOG=1 "
 export CFLAGS="$CFLAGS -DRELEASEID=1 -DRELEASE=1 -DNORAWSTREAM=1   -DRELEASEDIR=1  -DNOLOG=1 "
 export DEBUGOPT="-DDEBUG=OFF"
fi
echo $CXXFLAGS
