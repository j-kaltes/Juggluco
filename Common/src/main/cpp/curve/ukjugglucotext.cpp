...
"День назад         ",uktext.amount},
	...
	.scanerrors={
		...
		{"373: Помилка датчика","Не звертайтеся відразу до служби підтримки клієнтів Abbott; можливо, показники рівня глюкози доступні через 10 хвилин."},
		...
		{"365: Замініть датчик","Ваш датчик не працює. Видаліть датчик і запустіть новий."},
		{"368: Замініть датчик","Ваш датчик не працює. Видаліть датчик і запустіть новий."},
		{"",""},
